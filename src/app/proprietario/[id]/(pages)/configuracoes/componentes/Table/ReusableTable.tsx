...
export default function ReusableTable<T extends TableItem>({
  ...
  return (
    <div className="space-y-4">
        ...
        <table className="min-w-full">
          <thead className="bg-gray-50">
            <tr>
              ...
              <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">{displayFieldHeader}</th>
      ...
      {/* Container dos Controles de Paginação - Fundo transparente */}
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center space-x-3">
            <button
              ...
              className="inline-flex items-center px-3 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed disabled:bg-gray-100 transition-colors"
            >
              Anterior
            </button>
